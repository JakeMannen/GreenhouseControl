...
#define ZB_MANUFACTURER_NAME       CONFIG_ZIGBEE_MANUFACTURER_NAME
#define ZB_MODEL_IDENTIFIER        CONFIG_ZIGBEE_MODEL_IDENTIFIER
#define ZB_MODEL_HW_VERSION        CONFIG_ZIGBEE_HW_VERSION
